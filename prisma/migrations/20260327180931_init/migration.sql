/*
  ...
  - You are about to drop the column `saledId` on the `Purchases` table. All the data in the column will be lost.
  ...
  - Added the required column `saleId` to the `Purchases` table without a default value. This is not possible if the table is not empty.
...
ADD CONSTRAINT "Purchases_pkey" PRIMARY KEY ("saleId");
